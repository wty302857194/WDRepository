...
- (void)viewDidLoad {
    ...
    UITextField *nametf1 = [[UITextField alloc] initWithFrame:CGRectMake(10, 9, CGRectGetWidth(nameBackView.frame) - 20, 30)];
    nametf1.placeholder = @"请输入您的号码";
    nametf1.keyboardType = UIKeyboardTypeNumberPad;
    nametf1.tag = 101;
    ...
    nametf2.placeholder = @"请输入您的密码";
    nametf2.secureTextEntry = YES;
    nametf2.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
    nametf2.tag = 102;
